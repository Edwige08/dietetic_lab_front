...
interface CiqualData {
    ...
    "Vitamine B6 (mg/100 g)": string,
    "Vitamine B9 ou Folates totaux (µg/100 g)": string,
    "Vitamine B12 (µg/100 g)": string,
...
interface FoodDataWithQuantity {
    quantity: number,
    "AG 4:0, butyrique (g/100 g)": string,
    "AG 6:0, caproïque (g/100 g)": string,
    "AG 8:0, caprylique (g/100 g)": string,
