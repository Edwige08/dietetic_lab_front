...
export default function IngestaForm() {
    ...
    const addFood = (event: React.FormEvent) => {
        ...
        const foodAdded: FoodDataWithQuantity = {
            ...
            "energie_reg_ue_kcal": `${ciqualFood.energie_reg_ue_kcal === "" ? ciqualFood.energie_reg_ue_kcal : CalculateCalories(parseFloat(ciqualFood.proteines), parseFloat(ciqualFood.lipides), parseFloat(ciqualFood.glucides), parseFloat(ciqualFood.alcool))}`,
            "fer": ciqualFood.fer,
